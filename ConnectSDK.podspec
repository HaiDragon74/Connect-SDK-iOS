...
#
# * pod "ConnectSDK"
#     -> Core + GoogleCast (default, no Amazon Fling)
#
# * pod "ConnectSDK/Core"
#     -> Core only (Lite)
#
# * pod "ConnectSDK/GoogleCast"
#     -> Core + Google Cast
#
# * pod "ConnectSDK/FireTV"
#     -> Core + FireTV module
#        (Amazon Fling SDK must be added manually to the app project)
#
# NOTE:
# Amazon Fling SDK is NOT distributed via CocoaPods.
# It cannot be bundled here due to license and file size limits.
...
with multiple TV platforms. It abstracts device discovery and connectivity
across DLNA, DIAL, Chromecast, AirPlay, Roku ECG, webOS, and more.
DESC
...
PREFIX
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.exclude_files = (non_arc_files.dup <<
  ...
  # ============================================================
  # FireTV (Amazon Fling - manual integration required)
  # ============================================================
  ...
  s.subspec 'FireTV' do |sp|
    ...
    # Amazon Fling SDK must be added manually to the main app project.
    # Do NOT commit AmazonFling.xcframework into this repo.

    sp.frameworks = "UIKit", "Foundation"
  end

  # ============================================================
  # Default install (no FireTV)
  # ============================================================

  s.default_subspecs = 'Core', 'GoogleCast'
