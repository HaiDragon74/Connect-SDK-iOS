# There are three usage options of this podspec:
#
# * pod "ConnectSDK"
#     -> Core + GoogleCast (default)
#
# * pod "ConnectSDK/Core"
#     -> Core only (Lite)
#
...
#     -> Core + FireTV module
#        (Amazon Fling SDK must be added manually)
#
# NOTE:
...
PREFIX
  ...
  # ============================================================
  # FireTV (Manual Amazon Fling Integration Required)
  # ============================================================
  ...
  s.subspec 'FireTV' do |sp|
    ...
    # IMPORTANT:
    # AmazonFling.xcframework must be added manually
    # to the main application target.
    # Do NOT commit it into this repository.

    sp.frameworks = "UIKit", "Foundation"
  end

  # Default installation (no FireTV)
